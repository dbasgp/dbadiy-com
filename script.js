...
(function(){
  ...
  const T = {
    ...
    'ts.code.e1.d':              '機器切換至定時除霜。重新插接感應器；如持續，請聯絡維修。',
    'ts.code.e2.t':              '溫濕度感應器故障',
    'ts.code.e2.d':              '機器無法調控。重新插接 5 米感應器線於端子 1–3。',
    'ts.code.e3.t':              '水滿保護',
    'ts.code.e3.d':              '水盤未能清空。請檢查水泵出口、存水彎與管路斜度。',
    'ts.code.e4.t':              '冷媒低壓保護',
    'ts.code.e4.d':              '請聯絡維修，切勿反覆重置。',
    'ts.code.e7.t':              '漏水感應器觸發',
    'ts.code.e7.d':              '找出並清理漏水。代碼會自動消除。',
    'ts.code.e8.t':              '排氣高溫保護',
    'ts.code.e8.d':              '通常為風量受阻。請檢查濾網與風管。',
