...
(function(){
  ...
  const T = {
    ...
    'models.utc120.desc':        '大型住宅及輕型商業空間。R410A 雪種，雙進風口設計。',
    ...
    'models.spec.refrigerant':   '雪種',
    'models.spec.optemp':        '運作溫度',
    'models.spec.pump':          '排水泵揚程',
    'models.spec.pump.val':      '1.8 m（內置止回閥）',
    'models.spec.utc120.flange': '196 mm · 雙進風，單出風',
    ...
    'models.share.filter.d':     '可水洗，建議每3個月清潔一次。',
    ...
    'models.catfeat.house.t':    '全屋抽濕系統',
    'models.catfeat.house.d':    '同時為多個空間進行抽濕',
    ...
    'models.catfeat.motor.d':    '採用日本NSK軸承，穩定耐用',
    'models.catfeat.quiet.t':    '寧靜抽濕體驗',
    'models.catfeat.quiet.d':    '多重防震設計，運行噪音低至40dB',
    'models.next':               '查看安裝指南',
    ...
    'cases.eyebrow':             '實際工程',
    'cases.title':               '工程案例',
    'cases.pdf.label':           '工程參考資料',
    'cases.pdf.sub':             '點擊下載 PDF',
    ...
    /* Home / Knowledge tile */
    'home.kn.tag':               '安裝前必讀 · 問答',
    'home.kn.title':             '抽濕知識',
    'home.kn.desc':              '全屋抽濕如何運作？與冷氣、浴室寶相比慳幾多電？濕度應設定幾多？安裝前最常見的問題，一次過解答。',
    'home.kn.go':                '查看答案',

    /* Knowledge screen */
    'kn.title':                  '抽濕知識',
    'kn.desc':                   '安裝天花抽濕機前，客戶最常提出的問題與解答。點按問題即可展開內容。',
    'kn.ph':                     '相片稍後補上',
    'kn.next':                   '查看產品系列',

    /* Topic 1 — whole house */
    'kn.t1.h':                   '一機抽全屋 — 全屋抽濕系統',
    'kn.t1.d':                   '主機藏於假天花內，經風管把乾燥空氣送到每個房間。以下是實際的運作方式。',
    'kn.q11.tag':                '事前準備',
    'kn.q11.q':                  '安裝前需要具備甚麼條件？',
    'kn.q11.p1':                 '天花抽濕機安裝後完全隱藏，所以關鍵在於單位有沒有合適的安裝位置。大部分住宅都有 — 常見位置包括走廊假天花、浴室假天花，或儲物室、廚房上方的燈槽。',
    'kn.q11.b1':                 '<strong>天花深度</strong> — 假天花內需要約 20–30 cm 深度（視乎型號）。走廊及浴室的假天花一般已經足夠。',
    'kn.q11.b2':                 '<strong>檢修口</strong> — 機身下方需設一個小型天花檢修口，與隱藏式冷氣所用的相同；清洗濾網時經此取出。',
    'kn.q11.b3':                 '<strong>去水位</strong> — 冷凝水由內置水泵自動排走，揚程達 1.8 米，因此主機毋須緊貼去水位安裝。',
    'kn.q11.b4':                 '<strong>電源</strong> — 需由配電箱拉一組獨立迴路，屬安裝工程的一部分。',
    'kn.q11.p2':                 '如果單位正在裝修，以上對師傅來說都是常規工序；已入伙的單位則視乎天花結構而定 — 提供平面圖及現場相片，我們一般已可初步確認是否可行。技術細節可參閱<a href="#install">安裝指南</a>。',
    'kn.q11.fig':                '安裝於走廊假天花內的主機。',
    'kn.q12.tag':                '覆蓋範圍',
    'kn.q12.q':                  '一部機真的足夠抽全屋？',
    'kn.q12.p1':                 '足夠 — 這正是最常見的安裝方式。主機安裝於單位的中央位置（通常是走廊上方），乾燥空氣經風管分送到每個房間。一部主機最多可接駁五個送風口及五個回風口。',
    'kn.q12.p2':                 '以典型三房單位為例：主機位於走廊假天花內，客廳及每間睡房各設一個送風口；室內空氣經主機附近的回風口抽回、抽濕後再送出，於全屋不斷循環。特大單位或複式戶，一般建議以兩部較小的主機分區處理，效果比單一大機更好。',
    'kn.q12.fig':                '全屋風管布局 — 中央主機，每個房間一個送風口。',
    'kn.q13.tag':                '外觀',
    'kn.q13.q':                  '風口會是甚麼樣子？',
    'kn.q13.p1':                 '幼身天花風口，與隱藏式冷氣採用的款式相同。每個房間一個小型送風口（圓形或長條形），加上主機附近的回風口及檢修口，就是全部外露的部分。',
    'kn.q13.p2':                 '地面沒有機器，毋須倒水，亦沒有外露喉管 — 日常所見的，只有天花上的風口。',
    'kn.q13.fig':                '完工後的天花與送風口，外觀與隱藏式冷氣無異。',
    'kn.q14.tag':                '溫度',
    'kn.q14.q':                  '房間會否變熱？',
    'kn.q14.p1':                 '出風口的空氣會比室溫略暖，這是正常現象。抽濕機的原理，是先讓空氣經過低溫盤管冷凝除水，再經高溫盤管回暖送出；冷氣機把這些熱量排到室外，抽濕機則保留在室內。',
    'kn.q14.p2':                 '實際影響是室溫最多上升 1–2°C，而且只在壓縮機運轉時出現。增加的熱量約等於機器的耗電功率，即數百瓦，與房內多一兩個人相若；若同時開冷氣，基本上不會察覺。',
    'kn.q14.p3':                 '此外，同一溫度下，乾燥空氣的體感較涼：26°C、55% 濕度的環境，一般比 24°C、75% 更舒適，因為汗水能夠正常蒸發。多數用家的實際感受是全屋更清爽，而非更熱。',
    'kn.q15.tag':                '型號選擇',
    'kn.q15.q':                  '應該選哪個型號？',
    'kn.q15.b1':                 '<strong>200–400 呎</strong>（開放式或單房）— UTC20',
    'kn.q15.b2':                 '<strong>400–600 呎</strong> — UTC55',
    'kn.q15.b3':                 '<strong>500–1,000 呎</strong>（一般全屋）— UTC68，最常用的型號',
    'kn.q15.b4':                 '<strong>1,000–1,500 呎</strong>（大單位、小型辦公室）— UTC120',
    'kn.q15.p1':                 '如在兩個型號之間猶豫，建議選較大的一級：機器以部分負載運行時較寧靜，耗電相差不大，壓縮機壽命亦較長。若空間長期低溫（冷氣長開、酒藏），實際抽濕量會下降三成或以上，同樣應選大一級。',
    'kn.q15.p2':                 '四個型號的詳細規格，請參閱<a href="#overview/specs">產品概覽</a>。',

    /* Topic 2 — running cost */
    'kn.t2.h':                   '電費開支 — 與冷氣、浴室寶比較',
    'kn.t2.d':                   '實際耗電多少、可以節省多少，與家中現有的設備逐一比較。',
    'kn.q21.tag':                '對比冷氣',
    'kn.q21.q':                  '與冷氣相比，可以節省多少？',
    'kn.q21.p1':                 '先比較效率：冷氣每抽走一公升水，約耗電 <strong>1.4–1.8 度</strong>，因為抽濕只是製冷的副產品；專用抽濕機做同樣的工作，只需 <strong>0.4–0.6 度</strong>，相差三至四倍。',
    'kn.q21.p2':                 '再比較覆蓋範圍：想用冷氣控制全屋濕度，<strong>每個房間的冷氣都要開動</strong>；而且即使長開，室內濕度一般只能降至 <strong>65% 左右</strong>，因為室溫一到設定值，壓縮機便減速，抽濕亦隨之停止。一部天花抽濕機經風管覆蓋全屋，便能把整個單位穩定維持在 50–60%。',
    'kn.q21.p3':                 '把時間拉長到一整個月的全屋濕度控制，差距便相當明顯：一邊是一部數百瓦的主機按需要間歇運轉，另一邊是多部冷氣壓縮機日夜運行、濕度仍未達標。反映在電費單上，分別可以很大。',
    'kn.q21.p4':                 '其實兩者最適合分工：抽濕機負責維持 55% 濕度，冷氣只負責調節溫度 — 設定溫度可調高 2–3°C 而體感不變。以此組合運作的住宅，總電費一般比單靠冷氣節省 <strong>15–25%</strong>。',
    'kn.q22.tag':                '對比浴室寶',
    'kn.q22.q':                  '浴室寶與天花抽濕機，哪個較耗電？',
    'kn.q22.p1':                 '浴室寶明顯耗電得多。它的乾燥方式是加熱：以 <strong>1,500–2,800 瓦</strong>的 PTC 發熱元件把空氣加熱，再由風扇把這些暖濕空氣抽出室外 — 速度快，但用來加熱空氣的電力亦隨之排走，因此一般每次只開二三十分鐘。',
    'kn.q22.p2':                 '天花抽濕機的額定功率為 <strong>196–880 瓦</strong>（UTC20 至 UTC68），約為浴室寶的五分之一；水份經排水管排走，熱量留在室內。雖然每分鐘的抽濕速度較慢，但它專為長時間運作而設，維持的是全屋的濕度，而非單一浴室。',
    'kn.q22.p3':                 '簡單而言：頭半小時浴室寶較快；時間一長，抽濕機每度電所做到的工作遠遠拋離。',
    'kn.q23.tag':                '浴室',
    'kn.q23.q':                  '有了天花抽濕機，還需要浴室寶嗎？',
    'kn.q23.p1':                 '兩者功能不同。浴室寶有一項抽濕機無法取代的功能：<strong>即時暖風</strong> — 冬天洗澡前先為浴室加溫。如果重視這一點，可以保留。',
    'kn.q23.p2':                 '至於其餘的工作 — 平日保持浴室乾爽、防止天花及磁磚縫發霉、吹乾毛巾 — 抽濕機可以全天候處理，耗電亦低得多。不少用家最終只把浴室寶當作冬季暖風機，濕度全年交由抽濕機負責。',
    'kn.q24.tag':                '長開',
    'kn.q24.q':                  '24 小時運作，電費會否很高？',
    'kn.q24.p1':                 '24 小時運作正是它的設計用途，但「開着」不代表壓縮機不停運轉：全屋達到目標濕度後，壓縮機便會停止，只餘感應器監測，待濕度回升才重新啟動。',
    'kn.q24.p2':                 '在門窗關妥、濕度已受控的單位內，型號合適的機器大部分時間處於待機或低負載狀態，長期運作的平均耗電遠低於額定功率 — 比同一單位的冷氣低得多，亦比每次由高濕度重新抽起更省電。',
    'kn.q24.p3':                 '真正影響效率的不是長開，而是開窗抽濕 — 詳見下一部分。',
    'kn.q25.tag':                '冷氣局限',
    'kn.q25.q':                  '為甚麼冷氣做不到同樣效果？',
    'kn.q25.p1':                 '因為對冷氣而言，抽濕只是製冷的副產品，並非它控制的目標。只有壓縮機運轉、盤管夠凍時，水份才會被冷凝抽走；室溫一到設定值，壓縮機便減速或停止，抽濕亦隨即停止 — 無論當時室內有多潮濕。',
    'kn.q25.p2':                 '所以開冷氣的房間，濕度多數停留在 65–75%：冷氣控制的是溫度，不是濕度。抽濕模式（dry mode）有一定幫助，但它針對的仍是溫度，無法按濕度設定值持續運作。',
    'kn.q25.p3':                 '這個限制在清涼潮濕的天氣最為明顯，例如 22°C 的回南天：冷氣要抽濕就必須同時製冷，結果房間又凍又濕；關掉冷氣，濕氣又回來。抽濕機則可獨立於溫度控制濕度 — 這正是它的用途所在。',

    /* Topic 3 — everyday habits */
    'kn.t3.h':                   '日常使用 — 開窗、抽氣扇、晾衫',
    'kn.t3.d':                   '幾個日常習慣，直接影響系統的實際效果。',
    'kn.q31.tag':                '開窗',
    'kn.q31.q':                  '抽濕時可以開窗嗎？',
    'kn.q31.p1':                 '建議不要。開窗時，室外濕氣湧入的速度遠高於機器抽走水份的速度：壓縮機不停運轉，濕度卻始終無法達標，電力等於白白消耗。',
    'kn.q31.p2':                 '把抽濕範圍內的窗關好，機器很快便能達到目標濕度，之後進入待機。想通風的話，可以開窗十分鐘左右再關上 — 在密閉空間內，濕度很快便會回落。',
    'kn.q32.tag':                '新風',
    'kn.q32.q':                  '單位密封度高，不是更需要新鮮空氣嗎？',
    'kn.q32.p1':                 '這是合理的顧慮。現代住宅氣密度高，一家四口關窗睡一晚，睡房的二氧化碳濃度到早上可達 1,500–2,500 ppm，遠高於 1,000 ppm 的舒適標準。一般抽濕機只處理濕度，處理不了二氧化碳。',
    'kn.q32.p2':                 '解決方法有兩個：每日定時短暫開窗換氣，之後讓抽濕機回復濕度 — 對大部分家庭已經足夠；或選用<strong>新風淨化抽濕機</strong>（DBA GEC V 系列），抽濕之餘引入經 HEPA 過濾的室外新風，並根據內置二氧化碳及 PM2.5 感應器自動調節。哪一款較適合你的單位，歡迎查詢。',
    'kn.q33.tag':                '抽氣扇',
    'kn.q33.q':                  '抽濕浴室時，可否同時開抽氣扇？',
    'kn.q33.p1':                 '洗澡期間及洗澡後可以。把蒸氣直接抽出室外，比逐步冷凝更快，所以最初的十至十五分鐘應交給抽氣扇處理。',
    'kn.q33.p2':                 '要避免的是兩者長期同開：抽氣扇持續運作時，室外濕空氣會經門縫窗隙不斷補入室內，抽濕機便要不斷處理這些額外濕氣。較有效的做法是：洗澡時開抽氣扇，之後關掉，其餘時間由抽濕機維持。',
    'kn.q34.tag':                '濕度設定',
    'kn.q34.q':                  '濕度應設定在多少？',
    'kn.q34.p1':                 '<strong>55% RH</strong> 是適合大多數家庭的設定：體感舒適，霉菌無法生長，木地板及木傢俬亦保持穩定。50–60% 之間都屬理想範圍。',
    'kn.q34.p2':                 '設定值愈低，代價愈大：低於 50% 之後，抽濕量下降、運轉時間上升，而體感分別不大。較低的設定值應留給有實際需要的用途 — 例如酒藏、攝影器材或皮具，可設 45–50%。',
    'kn.q35.tag':                '晾衫',
    'kn.q35.q':                  '可以用來吹乾衣服嗎？',
    'kn.q35.p1':                 '可以，這也是實際使用中最常用的功能之一。一批洗好的濕衣，會向室內釋放約 1.5–2.5 公升水份；如果沒有抽濕，這些水份最終會被牆身、衣櫃吸收，形成霉味。',
    'kn.q35.p2':                 '把衣服晾在設有送風口的房間、關上房門、設定 50%，翌日早上便乾透 — 不受天氣影響，亦沒有室內晾衫常見的濕氣味。',
    'kn.q35.fig':                '設於送風口下方的室內晾衫位置。',

    /* Topic 4 — living with it */
    'kn.t4.h':                   '長遠使用 — 霉菌、噪音、去水',
    'kn.t4.d':                   '濕度受控之後，居住環境會有甚麼轉變。',
    'kn.q41.tag':                '霉菌',
    'kn.q41.q':                  '濕度要多低才能防霉？',
    'kn.q41.p1':                 '霉菌需要持續高於約 65% 的濕度才能生長。全屋維持在 60% 以下，霉菌便停止蔓延；50% 以下，塵蟎亦難以繁殖。衣櫃的霉味，一般在濕度穩定受控後一至兩星期內消散。',
    'kn.q41.p2':                 '重點在於<em>持續</em>：每星期集中抽一次作用有限，濕度一回升，霉菌便繼續生長。全天候維持 55% 的天花抽濕機，才能真正切斷這個循環 — 而長時間運作正是它的設計用途。',
    'kn.q42.tag':                '噪音',
    'kn.q42.q':                  '晚上會否聽到聲音？',
    'kn.q42.p1':                 '全系列於 3 米距離的噪音為 39–50 dB(A)（視乎型號），介乎耳語與輕聲交談之間，而且主機與室內尚隔一層假天花。夜間使用低風速時，大部分用家形容只有輕微風聲，與隱藏式冷氣相若。',
    'kn.q42.p2':                 '比規格更重要的是安裝質素：吊桿上的橡膠減震墊及法蘭位的軟管段，可阻止震動傳入樓宇結構。安裝妥當的話，天花若出現「咯咯」聲，代表有部件鬆脫，而非機器本身嘈吵 — 可參閱<a href="#manual/troubleshooting">故障排除</a>。',
    'kn.q43.tag':                '去水',
    'kn.q43.q':                  '抽出來的水去了哪裏？',
    'kn.q43.p1':                 '經排水管直接排走 — 全自動，毋須倒水，亦沒有水箱。內置水泵揚程達 1.8 米，排水管可先向上再橫越天花，接駁至最近的去水位。',
    'kn.q43.p2':                 '安全保護屬標準配置：去水一旦受阻，水滿感應器會令機器停機，並於控制面板顯示故障代碼，避免滿溢；天花內亦可加裝漏水感應線，偵測到水份即自動停機。',
    'kn.q43.fig':                '假天花內的排水接駁，由水泵自動排至最近的去水位。',
    'kn.q44.tag':                '保養',
    'kn.q44.q':                  '日常需要多少保養？',
    'kn.q44.p1':                 '主要是兩項：每約三個月經檢修口取出不鏽鋼濾網，以清水沖洗、風乾後裝回；每年安排一次檢查蒸發器及排水系統。做好這兩項，機器可以長年維持出廠效能。',
    'kn.q44.p2':                 '完整的保養時間表，請參閱<a href="#manual/maintenance">日常保養</a>章節。',
    ...
    'um.safety.ref.heading':     '雪種 — R410A 與 R32',
    'um.safety.ref.intro':       '雪種類型印於機身銘牌。如機型使用 R32 或 R290，請注意以下事項：',
    ...
    'um.safety.r4':              '<strong>切勿刺穿或燒毀</strong>雪種迴路。',
    ...
    'um.warranty.e1':            '<strong>雪種、配件、消耗品</strong>（如濾網）、運輸、安裝、拆除或人工費用。',
    ...
    'ts.1.b3':                   '從檢修口檢查蒸發器。室溫下蒸發器結霜 = 雪種不足，請致電維修。',
    ...
    'ts.2.b3':                   '啟動時的撞擊聲為壓縮機正常情況。如運作中持續撞擊 = 固定螺絲鬆動或雪種問題。',
    'ts.3.tag':                  '滲水',
    ...
    'ts.4.b4':                   '<strong>E4</strong> — 雪種低壓保護。請聯絡維修 — 切勿反覆重置。',
    ...
    'ts.7.tag':                  '壓縮機',
    'ts.7.title':                '開機後只有風扇運轉，壓縮機不啟動',
    'ts.7.b1':                   '目標濕度是否高於當前環境濕度？目標濕度必須低於環境濕度，壓縮機才會啟動。',
    'ts.7.b2':                   '確認機器處於抽濕模式，而非通風模式。',
    'ts.7.b3':                   '壓縮機停止後有 3 分鐘保護延遲，請等候後再觀察。屬設計正常，並非故障。',
    'ts.8.tag':                  'App',
    'ts.8.title':                '塗鴉 App 找不到抽濕機',
    'ts.8.b1':                   '手機必須連接 2.4 GHz WiFi，不支援 5 GHz 或雙頻自動切換網絡。',
    'ts.8.b2':                   '重新進入配對模式：長按風速鍵直至 WiFi 圖示閃爍。',
    'ts.8.b3':                   '如仍無法配對，嘗試重啟路由器，並確保 App 已更新至最新版本。',
    'ts.9.tag':                  '效果',
    'ts.9.title':                '機器持續運行，但濕度始終達不到目標',
    'ts.9.b1':                   '檢查有否持續濕氣來源：開窗、新裝修、未乾油漆、室內晾衣。',
    'ts.9.b2':                   '確認濾網清潔，並檢查出入風口有無遮擋。',
    'ts.9.b3':                   'UTC20 及 UTC55 的建議覆蓋面積有限，如房間過大，可能需要更高容量機型。',
    'ts.10.tag':                 '除霜',
    'ts.10.title':               '除霜圖示頻繁出現',
    'ts.10.b1':                  '除霜屬自動程序，屬正常現象，每次最多 8 分鐘，當蒸發器低於 −1°C 自動觸發。',
    'ts.10.b2':                  '天氣暖和但除霜頻繁，可能是雪種不足或濾網堵塞，令流經蒸發器的風量下降。',
    'ts.10.b3':                  '如室溫下每小時除霜超過一次，請聯絡維修。',
  ...
  const PAGES = {
    ...
    'knowledge':               { titleKey:'kn.title',                        titleEN:'Good to Know',        crumb:'',                       parent:'home' },
