...
(function(){
  ...
  const T = {
    ...
    'ip.gallery.title':          '現場試機相片',
    'ip.gallery.hint':           '左右滑動 →',
    'ip.gallery.c1':             '地面試機：控制盒與感應器已連接，準備進行 10 分鐘通電測試。',
    'ip.gallery.c2':             'LCD 顯示濕度逐漸下降 — 確認壓縮機正常運作。',
    'ip.gallery.c3':             '紙箱包裝暫時保留，以便有需要時退貨。',
    ...
    'ih.gallery.title':          '現場吊裝相片',
    'ih.gallery.c1':             '四條 M10 螺桿由樓板垂下，鎖緊前先校正水平。',
    'ih.gallery.c2':             '機腳與螺母之間加上橡膠減震墊。',
    'ih.gallery.c3':             '維修板那一面對準預定的檢修口位置。',
    ...
    'id.gallery.title':          '現場排水接駁',
    'id.gallery.c1':             '機身出水口後緊接上行存水彎。',
    'id.gallery.c2':             '保溫排水管接駁至最近的排水位。',
    'id.gallery.c3':             '驗收時的注水測試 — 由檢修口倒水。',
    ...
    'ic.r2':                     '主風管總長度（送風 + 回風）建議 10 米內。超過此長度，風量會損耗而下降。',
    ...
    'ic.gallery.title':          '現場風管走線',
    'ic.gallery.c1':             '機身法蘭與硬管之間的軟管段。',
    'ic.gallery.c2':             '分支出風口裝設手動風量調節閥。',
    'ic.gallery.c3':             '風量分配箱將氣流送往多個房間。',
    ...
    'ico.t1.t':                  '溫濕度感應器',
    'ico.t1.d':                  'GND · <span class="wire-r">+5V</span> · <span class="wire-y">DATA</span>。溫濕度感應器配備 5 米信號線，亦可使用其他多芯屏蔽信號線，建議長度不超過 20 米。',
    'ico.t2.t':                  '有線控制盒',
    'ico.t2.d':                  '<span class="wire-r">RX</span> · TX · <span class="wire-r">+5V</span> · <span class="wire-y">GND</span>。控制面板配備 8 米信號線，亦可使用其他多芯屏蔽信號線，建議長度不超過 20 米。',
    'ico.t3.t':                  '遠端開關（乾接點）',
    'ico.t3.d':                  '以任何 <strong>無電壓</strong> 的開關短接兩個端子 — 第三方開關控制。<strong>NO</strong>（預設）：短接 = 開機、開路 = 關機。<strong>NC</strong>：短接 = 關機、開路 = 開機（可於控制面板高級參數上切換，操作詳情請諮詢 DBA 客服）。',
    'ico.t4.t':                  '漏水感應線信號輸入',
    'ico.t4.d':                  '接駁標準漏水感應線，線上任何位置遇水即觸發故障代碼 <strong>E7</strong> 並自動停機。',
    'ico.t5.t':                  '運行狀態指示燈',
    'ico.t5.d':                  '當運行狀態正常時，綠燈常亮。當發生故障時，紅燈常亮。燈組的電源輸出為 <strong>220 V 6 A</strong>，可自行連接指示燈的兩組電源輸出。（請在斷電情況下進行）',
    ...
    'ico.gallery.title':         '線控與接線',
    'ico.gallery.c1':            'LCD 控制盒安裝於 86 型暗盒內。',
    'ico.gallery.c2':            '感應器線經穿管走入夾層。',
    'ico.gallery.c3':            '端子排上的 13 個接點均已逐一標示。',

    /* Install / Power */
    'ipw.pill':                  '步驟 06 / 07',
    'ipw.title':                 '電源',
    'ipw.desc':                  '專用迴路、確實接地。壓縮機啟動電流大，與其他電器共用迴路容易跳閘。',
    'ipw.chip.1':                '3 × 2.5 mm² 起跳',
    'ipw.chip.2':                '16 A 專用斷路器',
    'ipw.chip.3':                '標準接地',
    'ipw.wiring.heading':        '配線要求',
    'ipw.w1':                    '<strong>電線</strong> — 由配電箱拉至機身端子排，最少 3 × 2.5 mm²。走線超過 15 米需加大線徑。',
    'ipw.w2':                    '<strong>斷路器</strong> — 專用 16 A C 型 MCB。如當地法例要求，可改用 RCBO。',
    'ipw.w3':                    '<strong>接地</strong> — 接至機身上標明的接地端子（不是機殼螺絲），可用萬用表測試導通。',
    'ipw.w4':                    '<strong>隔離開關</strong> — 裝於檢修口附近，方便日後維修時就地切斷電源。',
    'ipw.order.heading':         '接線次序',
    'ipw.o1':                    '<strong>拉設電線</strong> — 由配電箱拉至機身，穿入線管。多餘長度於機箱外整齊盤好，切勿塞入機箱內。',
    'ipw.o2':                    '<strong>接駁線芯</strong> — 對應接到端子排上的 L、N、地線端子，螺絲鎖緊。',
    'ipw.o3':                    '<strong>接駁訊號線</strong> — 訊號線已標示端子編號，按號接駁。此時斷路器仍保持關閉。',
    'ipw.o4':                    '<strong>裝回檢修板</strong> — 機殼蓋好後再通電。檢修板上的安全聯鎖開關，是保護下一位維修人員的關鍵。',
    'ipw.o5':                    '<strong>從配電箱通電</strong> — 待控制盒啟動，再進行驗收測試。',
    'ipw.warn.t':                '機器帶電時切勿打開機殼。',
    'ipw.warn.b':                '壓縮機啟動瞬間電壓可達數百伏，跳閘後電容器仍可能殘留電壓。維修前先關掉斷路器、確認無電，再打開機殼。',

    'ipw.gallery.title':         '電源與隔離開關',
    'ipw.gallery.c1':            '配電箱內標示清楚的 16 A 專用斷路器。',
    'ipw.gallery.c2':            '3 × 2.5 mm² 電線接駁至機身端子排。',
    'ipw.gallery.c3':            '檢修口附近設有可達的隔離開關。',
    ...
    'icm.gallery.title':         '交付前的最後相片',
    'icm.gallery.c1':            '面板顯示目標 50% RH，環境濕度正逐漸下降。',
    'icm.gallery.c2':            '由檢修口進行的排水洩漏測試。',
    'icm.gallery.c3':            '檢修口閉合後的整體外觀。',
    ...
    'um.safety.ref.intro':       '冷媒類型印於機身銘牌。R410A <strong>不可燃</strong>。R32 為<strong>輕微可燃（A2L）</strong>，如機型使用 R32，請注意以下事項：',
    ...
    'um.overview.p3':            '<strong>溫濕度感應器</strong> — 5 米線，插入端子 1–3。',
    ...
    'um.overview.x1':            '<strong>入風口與出風口</strong> — 機身兩端。氣流方向印於機身頂部。',
    'um.overview.x2':            '<strong>防塵濾網</strong> — 由維修板側抽出。需定期清洗。',
    'um.overview.x3':            '<strong>維修板</strong> — 機身長邊，對應假天花的檢修口。',
    'um.overview.x4':            '<strong>排水出口</strong> — 機身底部，與維修板同一邊。',
    ...
    'um.ic.1.t':                 'WiFi 連線',
    'um.ic.1.d':                 'WiFi 已連線或處於 App 配對模式。',
    'um.ic.2.t':                 '主板通訊異常',
    ...
    'um.ic.5.t':                 '時間顯示',
    'um.ic.5.d':                 '顯示當前時間與定時設定。',
    'um.ic.6.t':                 '濕度',
    'um.ic.6.d':                 '當前環境濕度（%RH）。',
    'um.ic.7.t':                 '溫度',
    'um.ic.7.d':                 '當前環境溫度（°C）。',
    'um.ic.8.t':                 '風速',
    'um.ic.8.d':                 '高速或低速 — 以風速鍵切換。',
    'um.ic.9.t':                 '模式',
    'um.ic.9.d':                 '除濕或送風 — 以模式鍵切換。',
    'um.ic.10.t':                'UV 消毒',
    'um.ic.10.d':                'UV-C 燈開啟（限有此配置的型號）。',
    'um.ic.11.t':                '電源指示',
    'um.ic.11.d':                '機器處於開機狀態。',
    ...
    'um.op.p3':                  '<strong>壓縮機延遲：</strong>啟動條件成立時，風扇立即運轉，壓縮機 3 秒後啟動。',
    'um.op.mode.heading':        '運作模式',
    'um.op.m1':                  '<strong>除濕模式</strong>（開機預設）— 壓縮機按目標 %RH 循環運作。',
    'um.op.m2':                  '<strong>送風模式</strong> — 只開風扇，壓縮機停止。適合清新空氣但不需要除濕的時段。',
    ...
    'um.maint.normal.b':         '運作及停機時偶有冷媒流動聲，屬正常。出風口在除濕模式下吹出暖風，亦屬正常 — 那是壓縮機正在搬走的熱量。',
    ...
    'um.warranty.k1':            '<strong>香港</strong> — 德百信綠色科技（香港）有限公司 · +852 2541 1611 · dba@dba.hk',
    ...
    'um.warranty.done.t':        '操作說明閱讀完畢。',
    'um.warranty.done.b':        '下次需要查故障代碼、按鍵說明或設定範圍，手機開啟對應章節即可。',
