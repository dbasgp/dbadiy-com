...
(function(){
  ...
  const T = {
    ...
    'ip.bench.lede':             '開箱後將抽濕機置於地面或工作枱上，進行 10 分鐘通電檢查。安裝前後，機器均必須通電測試。這 10 分鐘可以節省日後拆裝整整一日。',
    'ip.bench.s1':               '<strong>開箱</strong> — 打開紙箱，將抽濕機平放於地面。包裝請暫時保留，以便有需要時退貨。',
    'ip.bench.s2':               '<strong>連接 LCD 控制面板</strong> — LCD 控制面板信號線連接機身端子 4–7。',
    'ip.bench.s3':               '<strong>連接溫濕度感應器</strong> — 溫濕度感應器連接機身端子 1–3。沒有有效讀數，機器不會進入除濕模式。',
    'ip.bench.s4':               '<strong>通電</strong> — 可暫用接地的 220–240 V 插座。',
    ...
    'ip.bench.s7':               '<strong>抽濕模式下運行超過 10 分鐘</strong> — 留意風扇和壓縮機運作時有沒有異常聲響。出風口有暖風吹出代表抽濕功能正常。亦可將溫濕度感應器靠近出風口，LCD 控制面板顯示的濕度值會逐漸下降。出風口內有金屬風機，切勿將手或物件伸入出風口。',
    'ip.bench.s8':               '<strong>檢查 LCD 控制面板</strong> — 確保 LCD 控制面板顯示及操作正常，無顯示故障代碼。',
    'ip.bench.ok':               '沒有錯誤代碼？可以開始安裝。',

    'ip.plan.heading':           '然後規劃，動工之前',
    'ip.plan.1':                 '<strong>確認天花夾層高度。</strong>UTC20 需要 200 mm、UTC68 需要 240 mm、UTC120 需要 310 mm — 並上下預留 20–30 mm 空隙，避免機身貼合樓板及假天花。',
    'ip.plan.2':                 '<strong>確定吊裝位置。</strong>標出四條螺桿固定於樓板的位置，避開樓板內已有的管線。',
    'ip.plan.3':                 '<strong>選定檢修口位置。</strong>尺寸建議採用 <strong>450 × 450 mm 或 600 × 600 mm</strong>，正對著機身的維修板那一面（即排水出口側）。不可偏離。濾網由此側抽出。',
    ...
    'ip.kit.10.d':               '以及一個獨立 13 A 220 V 電源插座，正規接地',
    'ip.kit.11.t':               '86 型暗盒',
