...
(function(){
  ...
  const T = {
    ...
    'home.kn.title':             '抽濕知識',
    'home.kn.desc':              '全屋抽濕點樣運作、同冷氣及浴室寶比較慳幾多電、開窗定關窗、應該設定幾多濕度 — 安裝之前，大家都會問的問題。',
    'home.kn.go':                '查看答案',

    /* Knowledge screen */
    'kn.title':                  '抽濕知識',
    'kn.desc':                   '安裝天花抽濕機之前，大家最常問的問題，逐條解答。點擊問題即可展開。',
    'kn.ph':                     '相片稍後補上',
    'kn.next':                   '查看產品系列',

    /* Topic 1 — whole house */
    'kn.t1.h':                   '一部機，抽全屋 — 全屋抽濕系統',
    'kn.t1.d':                   '一部主機收藏於假天花內，風管分送至每個房間。實際運作原理如下。',
    'kn.q11.tag':                '事前規劃',
    'kn.q11.q':                  '安裝之前，我需要知道甚麼？',
    'kn.q11.p1':                 '你的單位是否適合安裝天花抽濕機，取決於以下四項條件，安裝前都可以自行檢查：',
    'kn.q11.b1':                 '<strong>天花空間</strong> — 主機收藏於假天花或走廊燈槽內。UTC20 需要 200 mm 深度、UTC68 需要 240 mm、UTC120 需要 310 mm，上下再預留少許空隙。',
    'kn.q11.b2':                 '<strong>檢修口</strong> — 450 × 450 mm 或 600 × 600 mm，正對機身維修側板。日後清洗濾網就靠這個位置。',
    'kn.q11.b3':                 '<strong>排水路徑</strong> — 內置水泵揚程達 1.8 米，主機不必貼近去水位 — 但必須有一條可行的排水路線。',
    'kn.q11.b4':                 '<strong>獨立電源迴路</strong> — 220V 13A 獨立斷路器。壓縮機不宜與其他電器共用迴路。',
    'kn.q11.p2':                 '四項條件都符合的話，其餘就是風管路線的設計 — 詳情請參閱<a href="#install">安裝指南</a>。',
    'kn.q11.fig':                '主機安裝於樓板與假天花之間，上下各留空隙。',
    'kn.q12.tag':                '覆蓋範圍',
    'kn.q12.q':                  '一部機真的可以抽全屋？',
    'kn.q12.p1':                 '可以 — 這正是最常見的安裝方式，並非特例。主機通常安裝於走廊或浴室假天花內，風管分支將乾燥空氣送到每個房間。每部主機最多可接 5 個送風口及 5 個回風口。',
    'kn.q12.p2':                 '有兩個原則：送風加回風的風管總長建議在 10 米內；每條分支加裝手動風量調節閥，確保較遠的房間都分到風量。特大單位或複式戶，兩部較小的主機通常比一部大機效果更好。',
    'kn.q12.fig':                '典型佈局 — 主機位於走廊上方，分支風管送到每個房間。',
    'kn.q13.tag':                '外觀',
    'kn.q13.q':                  '風口會是甚麼樣子？',
    'kn.q13.p1':                 '幼身天花風口 — 與隱藏式冷氣所用的風口一樣。每個房間一個小型送風口（圓形或條形），主機附近一個回風口，加上檢修口。從下面望上去，能看見的就只有這些。',
    'kn.q13.p2':                 '地上沒有機器、沒有水箱、沒有外露喉管。大部份訪客根本不會察覺屋內有這套系統。',
    'kn.q13.fig':                '完工天花與送風口 — 外觀與隱藏式冷氣無異。',
    'kn.q14.tag':                '舒適度',
    'kn.q14.q':                  '房間會不會變得很熱？',
    'kn.q14.p1':                 '出風口的空氣會比入風口略暖 — 這是正常現象，也是抽濕機的工作原理：空氣先經冷凝器抽走水份，再經熱交換器回暖送出。冷氣機把熱量排到室外，抽濕機則把它留在室內。',
    'kn.q14.p2':                 '實際上室溫最多升高 1–2°C，而且只在壓縮機運轉期間。新增的熱量大約等於機器的耗電功率 — 幾百瓦，等於房內多一兩個人。若同時開冷氣，根本感覺不到。',
    'kn.q14.p3':                 '而且有一點大家往往意想不到：乾燥的空氣感覺<em>更涼</em>。26°C 配 55% 濕度，比 24°C 配 75% 更舒服，因為汗水終於可以蒸發。大部份用家的感覺是更涼快，而非更熱。',
    'kn.q15.tag':                '選型',
    'kn.q15.q':                  '我需要哪個型號？',
    'kn.q15.b1':                 '<strong>200–400 平方呎</strong>（開放式、單房）— UTC20',
    'kn.q15.b2':                 '<strong>400–600 平方呎</strong> — UTC55',
    'kn.q15.b3':                 '<strong>500–1,000 平方呎</strong>（一般全屋）— UTC68，最多人選用',
    'kn.q15.b4':                 '<strong>1,000–1,500 平方呎</strong>（大單位、小型辦公室）— UTC120',
    'kn.q15.p1':                 '猶豫時建議升一個型號。較大的機以部份負載運行，更靜、耗電相差無幾，壓縮機亦比長期全速運轉更耐用。長期低溫的空間（冷氣長開、酒窖）實際抽濕量會下降三成以上，同樣建議升級。',
    'kn.q15.p2':                 '四個型號的完整規格，請參閱<a href="#overview/specs">產品概覽</a>。',

    /* Topic 2 — running cost */
    'kn.t2.h':                   '電費 — 同冷氣、浴室寶比較',
    'kn.t2.d':                   '耗電多少、慳幾多，與家中現有電器的實際比較。',
    'kn.q21.tag':                '對比冷氣',
    'kn.q21.q':                  '同冷氣機比較，可以慳幾多電？',
    'kn.q21.p1':                 '冷氣機用抽濕模式抽走一公升水，大約耗電 <strong>1.4–1.8 度</strong> — 它天生是製冷的，抽濕只是副作用。專用抽濕機做同一件事只需 <strong>0.4–0.6 度</strong>，每公升慳三至四倍能源。',
    'kn.q21.p2':                 '更大的節省是間接的：由抽濕機負責維持 55% 濕度，冷氣就只需調節溫度 — 溫度可以調高 2–3°C 而體感一樣涼快，因為乾燥空氣讓汗水可以蒸發。兩機分工的住宅，總電費一般比冷氣獨力應付熱與濕<strong>低 15–25%</strong>。',
    'kn.q21.p3':                 '至於清涼但潮濕的晚上 — 回南天、香港的冬天 — 通常單靠抽濕機已經足夠，冷氣可以完全不開。',
    'kn.q22.tag':                '對比浴室寶',
    'kn.q22.q':                  '浴室寶同天花抽濕機，邊個更耗電？',
    'kn.q22.p1':                 '浴室寶，而且相差甚遠。它的乾燥方式是硬碰硬：PTC 電熱元件 — 一般 <strong>1,500–2,800 瓦</strong> — 把空氣加熱，再由風扇把這些昂貴的暖濕空氣直接排出室外。速度快，但等於用電煲暖空氣然後倒掉，所以大多數人只敢開二三十分鐘。',
    'kn.q22.p2':                 '天花抽濕機的額定功率只有 <strong>196–880 瓦</strong>（UTC20 至 UTC68）— 大約五分之一 — 而水份經排水管排走，不是連熱量一起丟出窗外。它每分鐘的速度較慢，但可以全日運作，維持全屋達到目標濕度，而不是只轟一個浴室。',
    'kn.q22.p3':                 '一個短跑，一個馬拉松：頭半小時浴室寶贏，之後每一小時都是抽濕機贏，而且電費只是零頭。',
    'kn.q23.tag':                '浴室',
    'kn.q23.q':                  '有了天花抽濕機，還需要浴室寶嗎？',
    'kn.q23.p1':                 '兩者的工作不同。浴室寶有一樣抽濕機做不到的功能：<strong>即時暖風</strong> — 冬天洗澡前先暖一暖浴室。如果你重視這一點，留着它。',
    'kn.q23.p2':                 '至於其他工作 — 洗澡之間保持浴室乾爽、防止天花與磁磚縫發霉、吹乾毛巾 — 抽濕機全日持續地做，耗電只是零頭。不少用家最後把浴室寶純粹當冬天暖風機用，濕度就全年交給抽濕機。',
    'kn.q24.tag':                '24 小時',
    'kn.q24.q':                  '24 小時開着，電費會不會很貴？',
    'kn.q24.p1':                 '24 小時運作正是它的設計用途 — 但「開着」不等於壓縮機不停地轉。當全屋達到目標濕度，壓縮機便停止，只剩感應器監察，濕度回升才重新啟動。',
    'kn.q24.p2':                 '在門窗關好、已經抽乾的單位裏，型號選對的機器大部份時間處於待機或低負載。長期運作的實際耗電遠低於額定功率 — 比同一單位的冷氣少得多，也比每次由潮濕狀態重新抽乾更划算。',
    'kn.q24.p3':                 '真正浪費電的習慣不是長開，而是開着窗抽濕。詳見下一部份。',
    'kn.q25.tag':                '取代冷氣？',
    'kn.q25.q':                  '它可以取代冷氣機嗎？',
    'kn.q25.p1':                 '在香港或新加坡的夏天不可以 — 炎熱天氣仍然需要真正的製冷。抽濕機移除的是水份，不是熱量。',
    'kn.q25.p2':                 '它取代的是冷氣的<em>運轉時間</em>。回南天、秋涼夜晚、冬季濕氣 — 那些你開冷氣只為了消除黏膩感的月份，抽濕機以零頭的耗電獨力應付。可以把它想成一年中其餘八個月專用的那部機。',

    /* Topic 3 — everyday habits */
    'kn.t3.h':                   '日常使用 — 開窗、抽氣扇、晾衫',
    'kn.t3.d':                   '幾個小習慣，決定這套系統是事半功倍還是事倍功半。',
    'kn.q31.tag':                '開窗',
    'kn.q31.q':                  '抽濕時可以開窗嗎？',
    'kn.q31.p1':                 '最好不要。開着窗抽濕，等於要一部機抽乾全城的空氣 — 濕氣湧入的速度快過任何機器抽走的速度。結果是壓縮機不停運轉、濕度永遠達不到目標、電費白白燒掉。',
    'kn.q31.p2':                 '把抽濕範圍的窗關好，機器很快達標，之後便進入待機。想透透氣的話，開窗十分鐘、關上，讓機器追回來 — 在密閉空間它恢復得很快。',
    'kn.q32.tag':                '新風',
    'kn.q32.q':                  '我的單位很密封 — 那不是需要新鮮空氣嗎？',
    'kn.q32.p1':                 '這是合理的疑問。現代住宅氣密度高，四人家庭關窗睡一晚，睡房 CO₂ 到清晨可達 1,500–2,500 ppm，遠超 1,000 ppm 的舒適標準。普通抽濕機解決濕度，解決不了 CO₂。',
    'kn.q32.p2':                 '兩個做法：每日短暫開窗一兩次，之後讓抽濕機追回濕度 — 對大部份家庭已經足夠；或者安裝<strong>新風淨化抽濕機</strong>（DBA GEC V 系列），抽濕同時引入經 HEPA 過濾的室外新風，並根據內置 CO₂ 及 PM2.5 感應器自動調節。哪款適合你的戶型，歡迎向我們查詢。',
    'kn.q33.tag':                '抽氣扇',
    'kn.q33.q':                  '抽濕浴室時，可以同時開抽氣扇嗎？',
    'kn.q33.p1':                 '洗澡期間和洗澡後 — 絕對可以。把蒸氣直接排出室外，比逐點冷凝更快，所以讓抽氣扇先做粗重工夫十至十五分鐘。',
    'kn.q33.p2':                 '但不要兩者長開。抽氣扇長開會不斷把室外的濕空氣經門縫窗隙抽進屋內 — 抽濕機變成在處理你自己引入的濕氣。有效的節奏是：洗澡開抽氣扇，之後關掉，餘下時間交給抽濕機維持。',
    'kn.q34.tag':                '濕度設定',
    'kn.q34.q':                  '濕度應該設定多少？',
    'kn.q34.p1':                 '<strong>55% RH</strong> 是適合絕大多數人的預設值 — 體感舒適、霉菌無法生長、木地板木傢俬穩定。50–60% 之間都沒有問題。',
    'kn.q34.p2':                 '設得再低，代價會不成比例：50% 以下機器抽濕量下降、運轉時間上升，而體感分別不大。低設定值留給真正需要的東西 — 酒藏、攝影器材、皮具衣櫃，設 45–50%。',
    'kn.q35.tag':                '晾衫',
    'kn.q35.q':                  '可以用來吹乾衣服嗎？',
    'kn.q35.p1':                 '可以 — 而且是實際使用中最受歡迎的功能之一。一機洗好的濕衣會向室內釋放 1.5–2.5 公升水份；沒有抽濕的話，這些水份最終走進牆身、衣櫃，變成那陣熟悉的霉味。',
    'kn.q35.p2':                 '把衣服晾在有送風口的房間、關門、設定 50%，翌日早上就乾 — 不用等太陽，沒有噏味，落雨照樣洗衫。',
    'kn.q35.fig':                '送風口下的室內晾衫架 — 一晚見效。',

    /* Topic 4 — living with it */
    'kn.t4.h':                   '長遠使用 — 霉菌、噪音、去水',
    'kn.t4.d':                   '濕度終於受控之後，屋企會有甚麼改變。',
    'kn.q41.tag':                '霉菌',
    'kn.q41.q':                  '濕度要幾多先真正防到霉？',
    'kn.q41.p1':                 '霉菌需要持續高於約 65% 的濕度才能生長。全屋維持 60% 以下，生長便停止；50% 以下塵蟎亦會減少。衣櫃的霉味一般在穩定控制一兩星期內消失。',
    'kn.q41.p2':                 '關鍵在於<em>持續</em>。一星期猛抽一次作用不大 — 霉菌孢子只是在等下一次潮濕。全日候維持 55% 的天花抽濕機，才能真正打斷這個循環 — 而這正是它的本職。',
    'kn.q42.tag':                '噪音',
    'kn.q42.q':                  '晚上會聽到聲音嗎？',
    'kn.q42.p1':                 '全系列於 3 米距離量得 39–50 dB(A)（視乎型號）— 由比耳語更靜到輕聲交談的水平 — 而且你與機器之間還隔着一層假天花。夜間用低風速，大部份用家形容為隱約的風聲，與隱藏式冷氣相若。',
    'kn.q42.p2':                 '比規格更重要的是安裝質素：吊桿上的橡膠減震墊、法蘭位的軟管段，能阻止震動傳入結構。安裝得宜的話，天花有「咯咯」聲代表有東西鬆了 — 而不是機器本身嘈。如遇到請參閱<a href="#manual/troubleshooting">故障排除</a>。',
    'kn.q43.tag':                '去水',
    'kn.q43.q':                  '抽出來的水去了哪裏？',
    'kn.q43.p1':                 '直接排入去水管 — 全自動，永遠不用倒水，沒有水箱。內置水泵揚程達 1.8 米，排水管可以先上後落，接駁到最近的去水位。',
    'kn.q43.p2':                 '安全措施是內置的：去水一旦堵塞，水滿感應器會停機並在面板顯示代碼，絕不讓水滿溢；天花內亦可加裝漏水感應線，一沾水即自動停機。',
    'kn.q43.fig':                '內置水泵將冷凝水提升至 1.8 米，排到最近的去水位。',
    'kn.q44.tag':                '保養',
    'kn.q44.q':                  '需要幾多打理？',
    'kn.q44.p1':                 '兩個習慣。每三個月左右沖洗一次不鏽鋼濾網 — 經檢修口抽出、水喉沖洗、風乾裝回。每年一次安排檢查蒸發器與排水系統 — 這就是機器十年如一日的秘訣。',
    'kn.q44.p2':                 '完整保養時間表請參閱<a href="#manual/maintenance">日常保養</a>章節。',
