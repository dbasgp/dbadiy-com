...
(function(){
  ...
  const T = {
    ...
    'models.utc20.desc':         '單一房間或工作室規格。於 26.7°C 60% RH 為 9.9 L/day。',
    'models.utc55.desc':         'UTC20 與 UTC68 之間的中型款。於 26.7°C 60% RH 為 30 L/day。',
    'models.utc55.refr':         'R32 · 0.3 kg（輕度可燃）',
    'models.utc68.tag':          'DBA-UTC68 · 熱銷',
    'models.utc68.desc':         '全屋抽濕首選。於 26.7°C 60% RH 為 42 L/day。',
    'models.utc120.desc':        '大型住宅及輕型商業空間，雙進風口。於 26.7°C 60% RH 為 52.8 L/day。',
    'models.spec.airflow':       '風量',
    'models.spec.power':         '功率',
    'models.spec.refrigerant':   '冷媒',
    'models.spec.pump':          '泵頭揚程',
    'models.spec.body':          '機身',
    'models.common.heading':     '全系列通用規格',
    'models.common.power':       '<strong>220–240 V · 50 Hz</strong>',
    'models.common.temp':        '<strong>運作溫度</strong> 5 – 40 °C',
    'models.common.pump':        '<strong>內置 1.8 米排水泵</strong>，附整合式止逆閥',
    'models.common.modes':       '<strong>除濕 + 通風模式</strong>，目標 10 – 95% RH',
    'models.feat.pump':          '✓ 內置 1.8 米排水泵及止逆閥',
    ...
    'ip.bench.lede':             '開箱後置於地面或工作枱上，進行 10 分鐘通電檢查。官方安裝卡明訂：「安裝前後，機器均必須通電測試。」這 10 分鐘可以節省日後拆裝整整一日。',
    'ip.bench.s1':               '<strong>開箱</strong> — 將機從紙箱取出，平放於地面，面板向上。包裝請暫時保留，以便有需要時退貨。',
    'ip.bench.s2':               '<strong>連接控制盒</strong>（端子 4–7）使用隨附的 8 米線。編號需一一對齊。',
    'ip.bench.s3':               '<strong>連接溫濕度感應器</strong>（端子 1–3）。沒有有效讀數，機器不會進入除濕模式。',
    'ip.bench.s4':               '<strong>插入電源。</strong>如專用迴路尚未鋪設，可暫用接地的 220–240 V 插座。',
    'ip.bench.s5':               '<strong>開機。</strong>風扇即時運轉，壓縮機於 3 秒延遲後啟動（屬設計延遲，並非故障）。',
    'ip.bench.s6':               '<strong>強制啟動壓縮機</strong> — 於面板將濕度目標設為約 40% RH。',
    'ip.bench.s7':               '<strong>以除濕模式運行超過 10 分鐘。</strong>留意有否異常聲響。於出風口感受暖風 — 代表壓縮機正常移熱。',
    'ip.bench.s8':               '<strong>過程中持續檢查 LCD</strong> — 無錯誤代碼、無進入除霜鎖定、結束時環境濕度應呈下降趨勢。',
    ...
    'ip.plan.3':                 '<strong>選定檢修口位置。</strong>依官方手冊：<strong>450 × 450 mm 或 600 × 600 mm</strong>，正對機身的維修板那一面（即排水出口側）。不可偏離。濾網由此側抽出。',
    'ip.plan.4':                 '<strong>提早規劃風管走線。</strong>繪出回風與送風路徑，標出彎位並計算數量 — 每個 90° 彎位約扣 10 Pa。',

    'ip.kit.heading':            '安裝所需材料',
    'ip.kit.intro':              '出自手冊第 6 頁 — 推薦吊裝配件，皆為 304 不鏽鋼：',
    ...
    'ip.kit.8.t':                '300–500 mm 軟管段',
    'ip.kit.8.d':                '機身法蘭與硬管之間的防震軟管',
    'ip.kit.9.t':                '保溫排水管',
    'ip.kit.9.d':                '連同上行存水彎（止逆閥已內置於機身）',
    'ip.kit.10.t':               '3 × 2.5 mm² 電線',
    'ip.kit.10.d':               '以及一個獨立 16 A 空氣開關，正規接地',
    'ip.kit.11.t':               '86 型暗盒',
    ...
    'id.pill':                   '步驟 03 / 07',
    'id.title':                  '排水',
    'id.desc':                   'UTC 系列內置可將冷凝水提升 1.8 米的水泵，止逆閥已整合於機內。只需加裝上行存水彎並接好排水管即可。',
    'id.chip.1':                 '1.8 米水泵提升',
    'id.chip.2':                 '止逆閥內置',
    'id.chip.3':                 '加裝上行存水彎',
    'id.illu.builtin':           '止逆閥內置',
    'id.illu.utrap':             '上行存水彎',
    'id.illu.stack':             '通往排水位',
    'id.path.heading':           '排水路徑',
    'id.path.1':                 '<strong>止逆閥已內置於機身</strong> — 不需額外加裝。可防止水泵停止時冷凝水倒流。',
